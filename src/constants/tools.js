...
export const TOOLS = [
  ...
  // ── Image Tools (Canvas API — 100% browser native) ──
  {
    id: 'image-compressor',
    slug: '/image-compressor',
    name: 'Image Compressor',
    shortName: 'Compressor',
    description: 'Compress JPG, PNG and WebP images. Quality slider, before/after preview, up to 90% size reduction.',
    icon: '🗜️',
    emoji: '🗜️',
    category: 'image',
    platforms: [],
  ...
  },
  {
    ...
    description: 'Resize images to any dimension with 15+ presets. Aspect ratio lock, stretch/contain/cover fit modes.',
    icon: '📐',
    emoji: '📐',
    category: 'image',
    platforms: [],
  ...
  },
  {
    ...
    description: 'Convert images between JPG, PNG, WebP, and AVIF formats. Quality control and browser capability detection.',
    icon: '🔄',
    emoji: '🔄',
    category: 'image',
    platforms: [],
  ...
  },
  {
    ...
    description: 'Crop images visually with drag-to-select. Aspect ratio presets: 1:1, 16:9, 9:16, 4:3 and more.',
    icon: '✂️',
    emoji: '✂️',
    category: 'image',
    platforms: [],
  ...
  },
  {
    ...
    description: 'Resize up to 20 images at once. Download all as a ZIP file. No upload, 100% in your browser.',
    icon: '📦',
    emoji: '📦',
    category: 'image',
    platforms: [],
...
export const CATEGORIES = [
  ...
  { id: 'image',  name: 'Image Tools',           description: 'Compress, resize, convert & crop images — 100% in-browser' },
];
