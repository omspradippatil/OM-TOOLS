        ...
        <section className="offline-hero">
          ...
          <div className="container">
            <div className="offline-hero__content">
              ...
              <h1 className="offline-hero__title">Merge PDF</h1>
              <p className="offline-hero__subtitle">
                Combine multiple PDF files into one document. 100% in your browser — no upload, no server, completely private.
              </p>
              <div className="offline-coming-soon">
                ...
                <p className="offline-cs__desc">
                  The Merge PDF tool is under development and will process files entirely in your browser using <strong>pdf-lib</strong>. 
                  Check out <a href="https://om-pdf.netlify.app" target="_blank" rel="noopener noreferrer" className="offline-cs__link">OM PDF</a> for a fully featured PDF toolkit in the meantime.
                </p>
